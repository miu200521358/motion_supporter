...
def read_history(mydir_path):
    # ファイル履歴
    file_hitories = {"parent_vmd": [], "parent_pmx": [], "noise_vmd": [], "multi_split_vmd": [], "multi_split_pmx": [], "ik2fk_vmd": [], "ik2fk_pmx": [], "max": 50}
    ...
    try:
        with open(os.path.join(mydir_path, 'history.json'), 'r') as f:
            ...
            # キーが揃っているかチェック
            for key in ["parent_vmd", "parent_pmx", "noise_vmd", "multi_split_vmd", "multi_split_pmx", "ik2fk_vmd", "ik2fk_pmx"]:
