...
ext = [Extension("module.MMath", sources=["module/MMath.pyx"], include_dirs=['.', bezier_path, get_include()]), \
       # Extension("module.MMath", sources=["module/MMath.pyx"], include_dirs=['.', bezier_path, get_include()], define_macros=[('CYTHON_TRACE', '1')]), \
       ...
       # Extension("utils.MServiceUtils", sources=["utils/MServiceUtils.pyx"], include_dirs=['.', bezier_path, get_include()], define_macros=[('CYTHON_TRACE', '1')]), \
