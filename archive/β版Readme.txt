...
MotionSupporter_1.07_β02 (2022/11/21)
・軌跡モデル生成
　・全ての親の表示先をZ=-5に変更（手前がどこか分かるように）
　・テクスチャ形式から材質形式に変更（6000Fで10KB程度しか違わないため）
　・100Fごとにボーン生成
　・表示切り替えモーフ追加

MotionSupporter_1.07_β01 (2022/11/21)
新規追加
　・軌跡モデル生成：　指定モーションのセンター（＋グルーブ）の移動をPMXモデルとして生成します
